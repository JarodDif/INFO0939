...
popt_ws_4e6 = curve_fit(gustafson, data_ws_4e6["processes"], ref_4e6/data_ws_4e6["time"]*data_ws_4e6["processes"])[0][0]
...
plt.plot(data_ws_4e6["processes"], ref_4e6/data_ws_4e6["time"]*data_ws_4e6["processes"], "-og", label="$4 \\ 10^6$ elements per process")
plt.plot(np_tab, gustafson(np_tab, popt_ws_4e6), "--g", label=f"Gustafson's law with $p ={popt_ws_4e6:.2f}$")
plt.xlabel('Number of processes')
